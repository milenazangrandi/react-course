...
CreateGuestForm.propTypes = {
    onSuccessNewGuest: PropTypes.object,
...
function CreateGuestForm({ onSuccessNewGuest, closeModal }) {
    ...
    const onSubmit = function (data) {
        const countryFlag = countries.find((country) => country.name === data.nationality).flag;
    ...
    return (
        <Form type="modal" onSubmit={handleSubmit(onSubmit)}>
            <FormRow label="Full name" error={errors?.fullName?.message}>
                <Input type="text" id="fullName" disabled={isCreating} {...register('fullName', { required: 'This field is required' })} />
            </FormRow>
            ...
            <FormRow>
                <Button variation="secondary" type="reset" disabled={isCreating} onClick={() => closeModal?.()}>
                    Cancel
                </Button>
